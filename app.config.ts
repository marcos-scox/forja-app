...
const rawBundleId = "com.app.forjaappmobile";
const bundleId =
  rawBundleId
...
const env = {
  ...
  appName: "Forja",
  appSlug: "forja-app-mobile",
  // S3 URL of the app logo - set this to the URL returned by generate_image when creating custom logo
  // Leave empty to use the default icon from assets/images/icon.png
  logoUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663922177451/AvPxBTwwdTqYZlio.png",
  scheme: "forja",
  iosBundleId: "com.marcoscox.forja",
  androidPackage: "com.marcoscox.forja",
};
